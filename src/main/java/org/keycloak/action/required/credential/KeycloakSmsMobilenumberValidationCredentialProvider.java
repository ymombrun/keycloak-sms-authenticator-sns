 ...
 */
public class KeycloakSmsMobilenumberValidationCredentialProvider implements CredentialProvider, CredentialInputValidator, CredentialInputUpdater, OnUserCache {
    public static final String MOBILE_NUMBER = "mobile_number";
    public static final String CACHE_KEY = KeycloakSmsMobilenumberValidationCredentialProvider.class.getName() + "." + MOBILE_NUMBER;

    protected KeycloakSession session;

    public KeycloakSmsMobilenumberValidationCredentialProvider(KeycloakSession session) {
