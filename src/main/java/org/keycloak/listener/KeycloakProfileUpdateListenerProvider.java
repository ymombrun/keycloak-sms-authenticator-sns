...
public class KeycloakProfileUpdateListenerProvider implements EventListenerProvider {

    private KeycloakSession session;
    private static Logger logger = Logger.getLogger(KeycloakProfileUpdateListenerProvider.class);

    public KeycloakProfileUpdateListenerProvider(KeycloakSession session) {
